...
--
-- Host: 127.0.0.1    Database: tiw2023up
-- ------------------------------------------------------
...
INSERT INTO `booking` VALUES (1,1),(2,1),(3,1),(1,2),(2,2),(3,2),(4,3),(3,4),(4,4),(1,5),(3,5),(4,5),(4,6),(5,6);
...
INSERT INTO `event` VALUES (1,'Visita',' Lab','20:30:00','2023-10-31','Milano',10,1),(2,'Lezione','TIW','21:00:00','2023-10-15','Lecco',5,2),(3,'Cinema','Turing Story','08:00:00','2023-09-30','Como',5,1),(4,'Esercitazione','TIW Thymeleaf','10:00:00','2023-09-30','Milano',15,3),(5,'Esame','TIW','12:00:00','2023-09-15','Piacenza',3,4),(6,'Esame','API','23:59:00','2023-08-24','Milano',2,4);
...
CREATE TABLE `like` (
  ...
  PRIMARY KEY (`idevent`,`idliker`),
  KEY `liker` (`idliker`),
  CONSTRAINT `event_like` FOREIGN KEY (`idevent`) REFERENCES `event` (`idevent`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `liker` FOREIGN KEY (`idliker`) REFERENCES `user` (`iduser`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `waiting` (
  ...
  `time` time NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`idevent`,`idwaiter`),
  KEY `waiter` (`idwaiter`),
  CONSTRAINT `event_wait` FOREIGN KEY (`idevent`) REFERENCES `event` (`idevent`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `waiter` FOREIGN KEY (`idwaiter`) REFERENCES `user` (`iduser`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-05 21:51:40
